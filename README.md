...
| Лицензия | [LICENSE](LICENSE) (MIT, ядро) |
...
**[MIT License](LICENSE)** — © 2026 ISPF Core Contributors (только ядро в `main`).

Коммерческие плагины и reference-стенды (oil-terminal) — вне `main`, со своей лицензией.  
См. [docs/LICENSE.md](docs/LICENSE.md), [docs/PLUGINS.md](docs/PLUGINS.md).
