...
/**
 * SNMP driver (v1/v2c) — polls OIDs and maps values to ISPF object variables.
 * <p>
...
public class SnmpDeviceDriver implements DeviceDriver {
    ...
    private static final DriverMetadata METADATA = new DriverMetadata(
            ...
            "SNMP Driver",
            "0.1.0",
            "Polls SNMP v1/v2c agents (GET/SET) and maps OID values to ISPF variables",
            "ISPF",
            Map.of(
                    "host", "127.0.0.1",
                    "port", "161",
    ...
    public void connect() throws DriverException {
        try {
            ...
            target.setAddress(parseAddress(host, port));
    ...
    private String versionLabel() {
        return snmpVersion == SnmpConstants.version1 ? "1" : "2c";
    }
}
